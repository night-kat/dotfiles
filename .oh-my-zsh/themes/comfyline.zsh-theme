...
# parse variables
#removed "currbat" from the list below, it doesnt work, gives error: BAT0: drectory does not exist
segments=("retval" "hostname" "username" "dir" "gitrepo" "venv" "currtime" "currdate")
